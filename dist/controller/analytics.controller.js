...
const getAnalyticsSummary = async (req, res) => {
    try {
        ...
        const accountObjId = new mongoose_1.default.Types.ObjectId(accountId);
        const monthsRequested = parseInt(months) || 6;
        ...
        const allocations = await MonthlyAllocations_1.MonthlyAllocation.find({
            accountId: accountObjId,
            $or: [
        ...
        const categoryData = await Transaction_1.Transaction.aggregate([
